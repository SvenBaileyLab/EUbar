...
def main():
    ...
    parser.add_argument("--kmerPositions", required=True, help="Path to k-mer position file")
    parser.add_argument("--genome", required=True, help="FASTA genome file")
    parser.add_argument("--region", required=True, help="Genomic region, e.g. chr6:1295220-1295228")
